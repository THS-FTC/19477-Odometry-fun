...
public class oneControllerTesting extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            right_bump1 = this.gamepad1.right_bumper;//right bumper: for the claw servo
            if (right_bump1) {
            ...
            left_bump1 = this.gamepad1.left_bumper;//left bumper: for the intake servo
            if (left_bump1){
    ...
    void getCone(){
        ...
        left_trig1 = this.gamepad1.left_trigger;//slide down
        right_trig1 = this.gamepad1.right_trigger;//slide up
        x1 = this.gamepad1.x;
        a1 = this.gamepad1.a;
        b1 = this.gamepad1.b;
        y1 = this.gamepad1.y;

        if (left_trig1 > 0.0 || right_trig1 > 0.0){//if either left/right trigger are pressed, execute manual slide height adjustments
            if(left_trig1 > 0.0 && armTarget > 0){
                armTarget -= 30;
                sleep(50);
                slide(armTarget);
            }
            else if(right_trig1 > 0.0 && armTarget < 10000){
                armTarget += 30;
                sleep(50);
                slide(armTarget);
            }
    ...
    void claw(){//open/close claw
        ...
        if(right_bump1 && (clawPos*300.0 <= (clawOpen+1.0) || clawPos*300.0 >= (clawClose-1.0))) {
            if (claw) {
